    ...
    <div class="dataGrid">
        <table class="tableHeader">
            ...
            <tr>
                ...
                <th :style="{'width': '15%', 'text-align': 'center'}">实例名称</th>
                <th :style="{'width': '50%', 'text-align': 'center'}">内网ip</th>
                <th :style="{'width': '10%', 'text-align': 'center'}">监控</th>
        ...
        <div class="tableDataWrapper">
            <table class="tableData">
                ...
                <tr v-for="(data, index) in datagridOptions.datas" @dblclick="doubleClick(index)">
                    ...
                    <td :style="{'width': '15%', 'text-align': 'center'}">{{ data.nickname }}</td>
                    <td :style="{'width': '50%', 'text-align': 'center'}">{{ data.internal_ip }}</td>
                    <td :style="{'width': '10%', 'text-align': 'center'}">
                        <router-link :to="{path: '/main/monitor/mserverList/' + data.id}">
                            <a href="javascript:void(0);" @click="showCharts(index)">查看</a>
                        </router-link>
                    </td>
